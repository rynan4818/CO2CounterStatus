...
namespace CO2Counter.Configuration
{
    internal class PluginConfig
    {
        ...
        public virtual float LabelFontSize { get; set; } = 2f;
        public virtual float FigureFontSize { get; set; } = 3f;
        public virtual float OffsetX { get; set; } = 0f;
        public virtual float OffsetY { get; set; } = 0f;
        public virtual float OffsetZ { get; set; } = 0f;
        public virtual string LabelText { get; set; } = "CO2 / Temp / RH";
